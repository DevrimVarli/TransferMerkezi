...
public class TdKayıtFrame extends JFrame {
	...
	public TdKayıtFrame() {
		...
		textTc.setBounds(209, 47, 96, 20);
		contentPane_1.add(textTc);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql1="INSERT INTO teknik_ekip1 (Tc,ad,sifre) VALUES ("+Tc+",'"+ad+"','"+sifre+"')";
				baglanti.ekle(sql1);
				//System.out.println("KAyıt basarili");
			}
		});
		btnNewButton.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 15));
		btnNewButton.setBounds(119, 164, 139, 20);

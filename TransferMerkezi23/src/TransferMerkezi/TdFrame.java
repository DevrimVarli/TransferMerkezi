...
public class TdFrame extends JFrame {
	...
	public TdFrame() {
		...
		btnListele = new JButton("ListeleGzlmci");
		btnListele.setBackground(new Color(255, 128, 255));
		btnListele.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 15));
		...
		btnListele.setBounds(407, 11, 125, 31);
		...
		JButton btnkayıt = new JButton("Ekle");
		btnkayıt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				sql_sorgu="INSERT INTO tdliste (id,ad,soyad,mevki,piyasa_degeri) VALUES ("+id+",'"+ ad +"',"+"'"+ soyad +"',"+"'"+ mevki +"',"+""+ piyasa_degeri +")";
